#!/usr/bin/env python3
"""
Iteration 3: Progressive Deceleration with proper distance prediction

Key fix: Predicted distances now properly reflect where the curve actually is
"""
...
# Improved transition times - faster for urgent situations
TRANSITION_TIMES = {
    EmergencyLevel.NORMAL: {EmergencyLevel.CAUTION: 0.3},
    EmergencyLevel.CAUTION: {EmergencyLevel.WARNING: 0.2},
    EmergencyLevel.WARNING: {EmergencyLevel.CRITICAL: 0.2},
    EmergencyLevel.CRITICAL: {EmergencyLevel.INTERVENTION: 0.3},
    'de_escalate': 2.0  # Slower when reducing emergency level
}


@dataclass
class VisionOcclusionStateV3:
...
class ProgressiveDecelerationV3:
    """Iteration 3 with proper distance handling"""
    ...
    def __init__(self):
        ...
        self.occlusion_state = VisionOcclusionStateV3()
    ...
    def update(self,
        ...
        """
        Main update with proper distance handling.
        actual_distance_to_curve: If provided, uses this as the true distance to the curve
        """
...
def test_iteration_3():
    ...
    controller = ProgressiveDecelerationV3()
    ...
    for i in range(100):  # 5 seconds max
        ...
        result = controller.update(
            ...
            current_time=time,
            actual_distance_to_curve=remaining_distance  # Pass actual distance
        )
