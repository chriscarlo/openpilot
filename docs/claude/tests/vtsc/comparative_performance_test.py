...
class VTSCComparativeTest:
    ...
    def run_all_tests(self) -> dict[str, Any]:
        ...
        all_results = {
            'test_info': {
                ...
                'physics_vtsc_path': '/data/openpilot/docs/claude/reference/vision_turn_controller_physics_based_original.py'
            },
            'scenarios': [],
            'summary': {}
        }
    ...
    def save_results(self, results: dict[str, Any], filename: str = 'vtsc_performance_results.json'):
        ...
        filepath = os.path.join('/data/openpilot/docs/claude/tests/vtsc', filename)
