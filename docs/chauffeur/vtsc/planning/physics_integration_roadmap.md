...
**Source (Physics Script)**: `/data/openpilot/docs/chauffeur/vtsc/reference/vision_turn_controller_physics_based_original.py`
...
**INTEGRATED SCRIPT**: `/data/openpilot/docs/chauffeur/vtsc/reference/vision_turn_controller_integrated.py` ✅ CREATED + SIMPLIFIED
