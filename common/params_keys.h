...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"Longitudinal.LiveTune.LeadPreviewStrength", {PERSISTENT | BACKUP, FLOAT, "1.8"}},
    ...
    {"Longitudinal.LiveTune.LeadAcquireWindowS", {PERSISTENT | BACKUP, FLOAT, "1.25"}},
    {"Longitudinal.LiveTune.GapReclaimStrength", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.GapReclaimGapMinM", {PERSISTENT | BACKUP, FLOAT, "0.0"}},
    {"Longitudinal.LiveTune.GapReclaimMaxAccel", {PERSISTENT | BACKUP, FLOAT, "0.24"}},
    {"Longitudinal.LiveTune.LeadKeepUpStrength", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    {"Longitudinal.LiveTune.LeadKeepUpGapMinM", {PERSISTENT | BACKUP, FLOAT, "0.40"}},
    {"Longitudinal.LiveTune.LeadKeepUpMaxAccel", {PERSISTENT | BACKUP, FLOAT, "0.08"}},
    {"Longitudinal.LiveTune.LeadSlowdownStrength", {PERSISTENT | BACKUP, FLOAT, "0.5"}},
    {"Longitudinal.LiveTune.LeadSlowdownMaxDecel", {PERSISTENT | BACKUP, FLOAT, "6.0"}},
    {"Longitudinal.LiveTune.CutInSettleDurationS", {PERSISTENT | BACKUP, FLOAT, "7.0"}},
    ...
    {"Longitudinal.LiveTune.CutInSettleAccelBiasMps2", {PERSISTENT | BACKUP, FLOAT, "0.20"}},
    {"Longitudinal.LiveTune.VirtualLeadSlowTauS", {PERSISTENT | BACKUP, FLOAT, "1.00"}},
    ...
    {"Longitudinal.LiveTune.KalmanDRelR", {PERSISTENT | BACKUP, FLOAT, "3.5"}},
    {"Longitudinal.LiveTune.KalmanDRelGainMax", {PERSISTENT | BACKUP, FLOAT, "0.35"}},
    {"Longitudinal.LiveTune.KalmanDRelDeadbandM", {PERSISTENT | BACKUP, FLOAT, "0.35"}},
    {"Longitudinal.LiveTune.DRelFilterTauCloseS", {PERSISTENT | BACKUP, FLOAT, "0.30"}},
    {"Longitudinal.LiveTune.DRelFilterTauOpenS", {PERSISTENT | BACKUP, FLOAT, "1.00"}},
    {"Longitudinal.LiveTune.DRelFilterOpenSlewMaxMps", {PERSISTENT | BACKUP, FLOAT, "1.25"}},
    {"Longitudinal.LiveTune.DRelFilterInnovationGateM", {PERSISTENT | BACKUP, FLOAT, "30.0"}},
    {"Longitudinal.LiveTune.DRelFilterClosingGateM", {PERSISTENT | BACKUP, FLOAT, "20.0"}},
    {"Longitudinal.LiveTune.CruiseReacquirePosJerkLimit", {PERSISTENT | BACKUP, FLOAT, "0.6"}},
    {"Longitudinal.LiveTune.CruiseReacquireJerkWindowS", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.LeadProbEnter", {PERSISTENT | BACKUP, FLOAT, "0.6"}},
    {"Longitudinal.LiveTune.LeadProbExit", {PERSISTENT | BACKUP, FLOAT, "0.35"}},
    {"Longitudinal.LiveTune.LeadSourceAcquireFrames", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    {"Longitudinal.LiveTune.LeadSourceReleaseFrames", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    {"Longitudinal.LiveTune.PhantomLeadHoldS", {PERSISTENT | BACKUP, FLOAT, "0.0"}},
    {"Longitudinal.LiveTune.PhantomLeadStableFrames", {PERSISTENT | BACKUP, FLOAT, "5.0"}},
    ...
    {"Longitudinal.LiveTune.FlutterClampJerkMps3", {PERSISTENT | BACKUP, FLOAT, "0.8"}},
