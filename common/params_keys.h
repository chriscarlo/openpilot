...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"RTISpeedReductionMode", PERSISTENT | BACKUP},
    {"RTIDetectionRadius", PERSISTENT | BACKUP},
    {"RTIForwardSlowdownRange", PERSISTENT | BACKUP},
    {"RTIResumeSpeedDistance", PERSISTENT | BACKUP},
