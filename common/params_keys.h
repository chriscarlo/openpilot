...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"VisionTurnSpeedControlDriverOverrideCurveProfile", {PERSISTENT | BACKUP, JSON}},
    ...
    {"VTSC.Expert.AdjLeadCutInDRelMaxM", {PERSISTENT | BACKUP, FLOAT, "60.0"}},
    ...
    {"Longitudinal.LiveTune.LeadPreviewGapMinM", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    {"Longitudinal.LiveTune.LeadPreviewMaxBufferM", {PERSISTENT | BACKUP, FLOAT, "10.0"}},
    {"Longitudinal.LiveTune.LeadAcquireWindowS", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.GapReclaimStrength", {PERSISTENT | BACKUP, FLOAT, "0.55"}},
    {"Longitudinal.LiveTune.GapReclaimGapMinM", {PERSISTENT | BACKUP, FLOAT, "3.0"}},
    {"Longitudinal.LiveTune.GapReclaimMaxAccel", {PERSISTENT | BACKUP, FLOAT, "0.30"}},
    ...
    {"Longitudinal.LiveTune.LeadSlowdownStrength", {PERSISTENT | BACKUP, FLOAT, "0.25"}},
    {"Longitudinal.LiveTune.LeadSlowdownMaxDecel", {PERSISTENT | BACKUP, FLOAT, "4.0"}},
    ...
    {"Longitudinal.LiveTune.LeadBrakeReleaseBrakeDeficitMarginM", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.LeadBrakeReleaseLookaheadS", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.LeadBrakeReleaseMinPullawayMps", {PERSISTENT | BACKUP, FLOAT, "0.10"}},
    {"Longitudinal.LiveTune.LeadBrakeReleaseNearTargetMarginM", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.LeadBrakeReleaseNearTargetMaxClosingMps", {PERSISTENT | BACKUP, FLOAT, "0.75"}},
    ...
    {"Longitudinal.LiveTune.LeadBrakeReleaseJerkMps3", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.CutInSettleDurationS", {PERSISTENT | BACKUP, FLOAT, "6.0"}},
    {"Longitudinal.LiveTune.CutInSettleMaxDecel", {PERSISTENT | BACKUP, FLOAT, "0.15"}},
    ...
    {"Longitudinal.LiveTune.KalmanDRelGainMax", {PERSISTENT | BACKUP, FLOAT, "0.25"}},
    {"Longitudinal.LiveTune.KalmanDRelDeadbandM", {PERSISTENT | BACKUP, FLOAT, "0.75"}},
    {"Longitudinal.LiveTune.DRelFilterTauCloseS", {PERSISTENT | BACKUP, FLOAT, "0.30"}},
    {"Longitudinal.LiveTune.DRelFilterTauOpenS", {PERSISTENT | BACKUP, FLOAT, "0.80"}},
    {"Longitudinal.LiveTune.DRelFilterOpenSlewMaxMps", {PERSISTENT | BACKUP, FLOAT, "1.80"}},
    {"Longitudinal.LiveTune.DRelFilterInnovationGateM", {PERSISTENT | BACKUP, FLOAT, "30.0"}},
    {"Longitudinal.LiveTune.DRelFilterClosingGateM", {PERSISTENT | BACKUP, FLOAT, "12.0"}},
    {"Longitudinal.LiveTune.CruiseReacquirePosJerkLimit", {PERSISTENT | BACKUP, FLOAT, "0.08"}},
    {"Longitudinal.LiveTune.CruiseReacquireJerkWindowS", {PERSISTENT | BACKUP, FLOAT, "3.0"}},
    {"Longitudinal.LiveTune.CruiseReacquireJerkRamp", {PERSISTENT | BACKUP, FLOAT, "0.8"}},
    {"Longitudinal.LiveTune.CruiseCollapseHoldbackS", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.CruiseExitLookbackFrames", {PERSISTENT | BACKUP, FLOAT, "7.0"}},
    {"Longitudinal.LiveTune.CruiseExitAbruptProbDrop", {PERSISTENT | BACKUP, FLOAT, "0.3"}},
    {"Longitudinal.LiveTune.CruiseRelatchBlendS", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.CruiseRelatchBlendJerkMps3", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.CruiseRelatchReleaseJerkMps3", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.CruiseRelatchUrgentTtcS", {PERSISTENT | BACKUP, FLOAT, "4.0"}},
    {"Longitudinal.LiveTune.CruiseRelatchUrgentClosingMps", {PERSISTENT | BACKUP, FLOAT, "8.0"}},
    {"Longitudinal.LiveTune.CruiseRelatchBypassDecelMps2", {PERSISTENT | BACKUP, FLOAT, "-1.5"}},
    {"Longitudinal.LiveTune.CruiseRelatchUrgentLeadDecelMps2", {PERSISTENT | BACKUP, FLOAT, "-1.0"}},
    {"Longitudinal.LiveTune.CruiseRelatchMaxDecelMps2", {PERSISTENT | BACKUP, FLOAT, "-0.15"}},
    {"Longitudinal.LiveTune.CruiseRelatchKinematicHeadroom", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    ...
    {"Longitudinal.LiveTune.ApproachReleaseTtcHysteresisS", {PERSISTENT | BACKUP, FLOAT, "2.5"}},
    ...
    {"Longitudinal.LiveTune.StoppingReleaseJerkMps3", {PERSISTENT | BACKUP, FLOAT, "6.0"}},
    ...
    {"Longitudinal.LiveTune.LeadSourceReleaseFrames", {PERSISTENT | BACKUP, FLOAT, "20.0"}},
    {"Longitudinal.LiveTune.PhantomLeadHoldS", {PERSISTENT | BACKUP, FLOAT, "0.80"}},
    {"Longitudinal.LiveTune.PhantomLeadStableFrames", {PERSISTENT | BACKUP, FLOAT, "3.0"}},
    {"Longitudinal.LiveTune.PhantomLeadDecelHoldFactor", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    {"Longitudinal.LiveTune.PhantomLeadDecelTrendGain", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    {"Longitudinal.LiveTune.FlutterDetectTransitions", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.FlutterDetectWindowS", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    {"Longitudinal.LiveTune.FlutterClampJerkMps3", {PERSISTENT | BACKUP, FLOAT, "0.12"}},
    {"Longitudinal.LiveTune.FlutterClampBypassDecelMps2", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.FlutterClampBrakeJerkMps3", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.ModelLeadFilterTauS", {PERSISTENT | BACKUP, FLOAT, "2.80"}},
    ...
    {"Longitudinal.LiveTune.ModelLeadFilterBlendTauFloorS", {PERSISTENT | BACKUP, FLOAT, "0.30"}},
    {"Longitudinal.LiveTune.ModelLeadFilterBlendCloseLoMps", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    {"Longitudinal.LiveTune.ModelLeadFilterBlendTtcHiS", {PERSISTENT | BACKUP, FLOAT, "12.0"}},
    {"Longitudinal.LiveTune.ModelLeadFilterBlendSlewBoostMps", {PERSISTENT | BACKUP, FLOAT, "6.0"}},
    {"Longitudinal.LiveTune.ModelLeadFilterLagCompS", {PERSISTENT | BACKUP, FLOAT, "0.6"}},
    {"Longitudinal.LiveTune.ModelLeadFilterLagCompDeadzoneMps", {PERSISTENT | BACKUP, FLOAT, "0.5"}},
    {"Longitudinal.LiveTune.ModelLeadFilterLagCompFadeLoMps", {PERSISTENT | BACKUP, FLOAT, "12.0"}},
    {"Longitudinal.LiveTune.ModelLeadFilterLagCompFadeHiMps", {PERSISTENT | BACKUP, FLOAT, "18.0"}},
    {"Longitudinal.LiveTune.ModelLeadFilterFastCloseConfirmFrames", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.ModelLeadFilterOpenRecoveryConfirmFrames", {PERSISTENT | BACKUP, FLOAT, "4.0"}},
    {"Longitudinal.LiveTune.ModelLeadFilterOpenRecoveryTauS", {PERSISTENT | BACKUP, FLOAT, "0.5"}},
    {"Longitudinal.LiveTune.ModelLeadFilterOpenRecoveryMaxEgoMps", {PERSISTENT | BACKUP, FLOAT, "8.0"}},
    {"Longitudinal.LiveTune.ModelLeadFilterOpenRecoveryInnovGateM", {PERSISTENT | BACKUP, FLOAT, "2.5"}},
    ...
    {"Longitudinal.LiveTune.LeadAccelCorrClosingGuardMps", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.LeadAccelCorrNearHeadwayS", {PERSISTENT | BACKUP, FLOAT, "1.2"}},
    {"Longitudinal.LiveTune.LeadAccelCorrClosingRearmMps", {PERSISTENT | BACKUP, FLOAT, "0.5"}},
    {"Longitudinal.LiveTune.LeadAccelCorrTtcRearmS", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.LeadAccelCorrHeadwayRearmM", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.LeadAccelCorrSettleTauMult", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.LeadAccelCorrMaxDtS", {PERSISTENT | BACKUP, FLOAT, "0.5"}},
    {"Longitudinal.LiveTune.LeadAccelCorrAmplifyGain", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    {"Longitudinal.LiveTune.LeadAccelCorrAmplifyModelDecelMinMps2", {PERSISTENT | BACKUP, FLOAT, "0.10"}},
    {"Longitudinal.LiveTune.LeadAccelCorrAmplifyDeadbandMps2", {PERSISTENT | BACKUP, FLOAT, "0.35"}},
    {"Longitudinal.LiveTune.LeadAccelCorrAmplifyCapMps2", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    {"Longitudinal.LiveTune.LeadStabilizerTrendTauS", {PERSISTENT | BACKUP, FLOAT, "0.20"}},
    {"Longitudinal.LiveTune.LeadStabilizerTrendDRelJumpM", {PERSISTENT | BACKUP, FLOAT, "3.0"}},
    {"Longitudinal.LiveTune.LeadStabilizerTrendYRelJumpM", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.ModelLeadBlendMinSpan", {PERSISTENT | BACKUP, FLOAT, "0.01"}},
    {"Longitudinal.LiveTune.ModelLeadBlendTtcMinClosingMps", {PERSISTENT | BACKUP, FLOAT, "0.3"}},
    {"Longitudinal.LiveTune.ModelLeadAssocDPathGateM", {PERSISTENT | BACKUP, FLOAT, "1.8"}},
    {"Longitudinal.LiveTune.ModelLeadAssocYRawTolM", {PERSISTENT | BACKUP, FLOAT, "7.0"}},
    {"Longitudinal.LiveTune.ModelLeadStepGuardAbsM", {PERSISTENT | BACKUP, FLOAT, "3.0"}},
    {"Longitudinal.LiveTune.ModelLeadStepGuardFrac", {PERSISTENT | BACKUP, FLOAT, "0.10"}},
    {"Longitudinal.LiveTune.LeadVLeadOptimismClampRangeM", {PERSISTENT | BACKUP, FLOAT, "55.0"}},
    {"Longitudinal.LiveTune.LeadVLeadOptimismClampGain", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    {"Longitudinal.LiveTune.LeadVLeadOptimismClampConfirmFrames", {PERSISTENT | BACKUP, FLOAT, "3.0"}},
    {"Longitudinal.LiveTune.LeadVLeadOptimismClampSlowLeadFrac", {PERSISTENT | BACKUP, FLOAT, "0.5"}},
    {"Longitudinal.LiveTune.ClosingGovernorMarginMps", {PERSISTENT | BACKUP, FLOAT, "0.75"}},
    {"Longitudinal.LiveTune.ClosingGovernorMinClosingMps", {PERSISTENT | BACKUP, FLOAT, "0.30"}},
    {"Longitudinal.LiveTune.ClosingGovernorWindowS", {PERSISTENT | BACKUP, FLOAT, "0.60"}},
    {"Longitudinal.LiveTune.ClosingGovernorAccelOnsetMps2", {PERSISTENT | BACKUP, FLOAT, "0.35"}},
    {"Longitudinal.LiveTune.ClosingGovernorPosTrustExcessMps", {PERSISTENT | BACKUP, FLOAT, "1.5"}},
    {"Longitudinal.LiveTune.ClosingGovernorUnconfirmedALeadTrustMps", {PERSISTENT | BACKUP, FLOAT, "0.41"}},
    {"Longitudinal.LiveTune.ClosingGovernorHoldS", {PERSISTENT | BACKUP, FLOAT, "1.0"}},
    ...
    {"Longitudinal.LiveTune.ClosingRecoveryBridgeMaxPositionClosingMps", {PERSISTENT | BACKUP, FLOAT, "0.0"}},
    {"Longitudinal.LiveTune.SteadyParityTrustDeficitMps", {PERSISTENT | BACKUP, FLOAT, "0.20"}},
    {"Longitudinal.LiveTune.SteadyParityVRelSlewMps2", {PERSISTENT | BACKUP, FLOAT, "0.80"}},
    {"Longitudinal.LiveTune.SteadyParityHoldS", {PERSISTENT | BACKUP, FLOAT, "0.50"}},
    {"Longitudinal.LiveTune.CruiseCapRawLeadAcquireDwellS", {PERSISTENT | BACKUP, FLOAT, "0.60"}},
    {"Longitudinal.LiveTune.CruiseCapRawLeadReleaseHoldS", {PERSISTENT | BACKUP, FLOAT, "0.50"}},
    {"Longitudinal.LiveTune.CruiseCapRawLeadMaxSampleGapS", {PERSISTENT | BACKUP, FLOAT, "0.30"}},
    {"Longitudinal.LiveTune.CruiseCapRawLeadMaxDRelStepM", {PERSISTENT | BACKUP, FLOAT, "6.0"}},
    {"Longitudinal.LiveTune.CruiseCapRawLeadMaxDPathStepM", {PERSISTENT | BACKUP, FLOAT, "0.75"}},
    {"Longitudinal.LiveTune.CruiseCapRawLeadMaxYRelStepM", {PERSISTENT | BACKUP, FLOAT, "1.50"}},
    {"Longitudinal.LiveTune.CruiseCapRawLeadSuspectYRelM", {PERSISTENT | BACKUP, FLOAT, "4.0"}},
    {"Longitudinal.LiveTune.CruiseCapRawLeadSuspectVLatMps", {PERSISTENT | BACKUP, FLOAT, "4.0"}},
    {"Longitudinal.LiveTune.LaunchReleaseMinDrelM", {PERSISTENT | BACKUP, FLOAT, "5.0"}},
    {"Longitudinal.LiveTune.LaunchReleaseDepartGateM", {PERSISTENT | BACKUP, FLOAT, "0.20"}},
    {"Longitudinal.LiveTune.LaunchFollowAccelFloorMaxMps2", {PERSISTENT | BACKUP, FLOAT, "1.8"}},
    {"Longitudinal.LiveTune.ObstacleCost", {PERSISTENT | BACKUP, FLOAT, "2.0"}},
    ...
    {"MapWholeCurveProfile", {CLEAR_ON_ONROAD_TRANSITION, JSON}},
    ...
    {"WeatherCondition", {CLEAR_ON_OFFROAD_TRANSITION, STRING}},           // JSON from weatherd (Pirate Weather point-precip)
    {"WeatherPointManualApiKey", {PERSISTENT | BACKUP | DONT_LOG, STRING}},// Pirate Weather API key override
    ...
    {"WeatherOverlayRangeKm", {PERSISTENT | BACKUP, INT, "16"}},           // ~10 mi default
    {"WeatherOverlayZoomLevel", {PERSISTENT | BACKUP, INT, "7"}},          // RainViewer free tier caps at z=7
