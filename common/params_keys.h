...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"Longitudinal.LiveTune.GapReclaimMaxAccel", {PERSISTENT | BACKUP, FLOAT, "0.12"}},
    {"Longitudinal.LiveTune.GapReclaimFollowMaxAccel", {PERSISTENT | BACKUP, FLOAT, "0.25"}},
    ...
    {"Longitudinal.LiveTune.LeadKeepUpMaxAccel", {PERSISTENT | BACKUP, FLOAT, "0.095"}},
