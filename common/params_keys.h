...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"Longitudinal.LiveTune.CruiseRelatchUrgentClosingMps", {PERSISTENT | BACKUP, FLOAT, "2.5"}},
    ...
    {"Longitudinal.LiveTune.CruiseRelatchMaxDecelMps2", {PERSISTENT | BACKUP, FLOAT, "-0.8"}},
