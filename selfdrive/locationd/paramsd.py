...
def main():
  ...
  while True:
    ...
    #
    # If this gate fails in the field, treat that as an upstream comm/data issue
    # to be fixed at the source (producer, transport, or scheduler), not by
    # weakening the gate here.
