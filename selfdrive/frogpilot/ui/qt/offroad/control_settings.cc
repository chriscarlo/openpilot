...
FrogPilotControlsPanel::FrogPilotControlsPanel(SettingsWindow *parent) : FrogPilotListWidget(parent) {
  ...
  const std::vector<std::tuple<QString, QString, QString, QString>> controlToggles {
    ...
    {"TrafficFollow", tr("Following Distance at 60 mph"), tr("Set the following distance for the 'Traffic' personality at 60 mph. This value will be dynamically adjusted based on speed.\n\nStock: 1.25 seconds."), ""},
    ...
    {"AggressiveFollow", tr("Following Distance at 60 mph"), tr("Set the following distance for the 'Aggressive' personality at 60 mph. This value will be dynamically adjusted based on speed.\n\nStock: 1.25 seconds."), ""},
    ...
    {"StandardFollow", tr("Following Distance at 60 mph"), tr("Set the following distance for the 'Standard' personality at 60 mph. This value will be dynamically adjusted based on speed.\n\nStock: 1.45 seconds."), ""},
    ...
    {"RelaxedFollow", tr("Following Distance at 60 mph"), tr("Set the following distance for the 'Relaxed' personality at 60 mph. This value will be dynamically adjusted based on speed.\n\nStock: 1.75 seconds."), ""},
