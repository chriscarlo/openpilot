...
LEAD_RESPONSE_TUNE_SPECS = (
  ...
  LeadResponseTuneSpec(
    ...
    minimum=0.0,
    maximum=50.0,
    description="CD7 (road 200-10 / 200-9 tap1 / 201-9 plus 2026-07-12 twitch trace): graded-onset comfort anti-jerk "
                "envelope on the planner's FINAL output_a_target. Bounds the per-frame DOWNWARD (comfort-braking-onset) "
                "delta output_a_target to "
