    ...
    for control_idx in range(control_ticks_per_step):
      ...
      trace.append({
        ...
        **follow_geometry,
        ...
        "mpc_lead_stability_debug": _to_builtin(getattr(planner.mpc, "lead_stability_debug", {})),
        ...
        "planner_steady_parity_threat_debug": _to_builtin(getattr(planner, "steady_parity_threat_debug", {})),
