...
class TinygradSplitRunner(ModelRunner):
  ...
  def _run_model(self) -> NumpyDict:
    ...
    off_policy_output = self.off_policy_runner.run_model() if self.off_policy_runner is not None else None
    return merge_split_model_outputs(policy_output, vision_output, off_policy_output)
  ...
  def input_shapes(self) -> ShapeDict:
    ...
    if self.off_policy_runner is not None:
