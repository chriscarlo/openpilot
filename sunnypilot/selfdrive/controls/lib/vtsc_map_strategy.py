...
WINDING_BEHAVIOR_PROFILES: dict[int, WindingBehaviorProfile] = {
  ...
  2: WindingBehaviorProfile(
    ...
    curve_phase_offset_adjust_s=0.08,
    overshoot_phase_offset_adjust_s=0.05,
    apex_release_lat_acc_ratio=0.70,
  ...
  3: WindingBehaviorProfile(
    ...
    apex_release_lat_acc_ratio=0.55,
  ...
  4: WindingBehaviorProfile(
    ...
    curve_phase_offset_adjust_s=0.16,
    overshoot_phase_offset_adjust_s=0.11,
    apex_release_lat_acc_ratio=0.45,
  ...
  5: WindingBehaviorProfile(
    ...
    curve_phase_offset_adjust_s=0.20,
    overshoot_phase_offset_adjust_s=0.14,
    apex_release_lat_acc_ratio=0.35,
