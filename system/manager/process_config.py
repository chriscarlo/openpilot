...
procs = [
  # DISABLED: Skip athenad for this branch - using custom backend
...
procs += [
  ...
  PythonProcess("modeld_tinygrad", "sunnypilot.modeld_v2.modeld", and_(only_onroad, is_tinygrad_model)),
